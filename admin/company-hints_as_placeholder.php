										...
										<div class="row">
											<div class="col-md-5 left_form__company">
												<label for="" class="wrap_input">
													...
													<div class="wrap_count">
														...
														<input type="text" maxlength="30" placeholder="Название отображаемое в меню" class="input_style w100 count_output">
													</div>
												</label>
												<label for="" class="wrap_input">
													<div class="title_input">
													...
													<div class="wrap_count">
														...
														<input type="text" maxlength="30" placeholder="Название отображаемое на странице" class="input_style w100 count_output">
													</div>
												</label>
												<label for="" class="wrap_input">
													<div class="title_input">
													...
													<input type="text" maxlength="30" placeholder="Адрес страницы отображаемый в адресной строке" class="input_style w100 count_output">
												</label>
												<label for="" class="wrap_input">
													<div class="title_input">
														Summary
													...
													<div class="wrap_count">
														...
														<textarea name="" id="" maxlength="120" placeholder="Краткое описание" class="textarea_style w100 count_output"></textarea>
													</div>
												</label>
											</div>
											<div class="col-md-7 right_form__company">
												...
												<div class="img_block__company_wrap">
													...
													<a href="#" class="btn_common_styles btn_gray btn_add_big">
														Add image
													</a>
												</div>
											</div>
											<div class="col-xs-12">
												<label for="" class="wrap_input mt17">
													...
													<textarea name="" id="" placeholder="Содержимое страницы" class="textarea_style editor_style"></textarea>
												</label>
											</div>
										</div>
									</form>
										...
										<div class="col-md-6">
											<label for="" class="wrap_input">
												...
												<div class="wrap_count">
													...
													<input type="text" maxlength="60" placeholder="Заголовок страницы для вкладки браузера" class="input_style w100 count_output">
												</div>
											</label>
											<label for="" class="wrap_input">
												<div class="title_input">
												...
												<textarea name="" id="" placeholder="Вводите через запятую." class="textarea_style w100"></textarea>
											</label>
										</div>
										<div class="col-md-6">
											<label for="" class="wrap_input">
												...
												<div class="wrap_count">
													...
													<textarea name="" id="" maxlength="155" placeholder="Описание страницы для поисковых систем" class="textarea_style w100 h200"></textarea>
												</div>
											</label>
										</div>
										<div class="col-md-12">
											<div class="title_input mt17">
												Как это будет выглядеть в Google?
											</div>
											<div class="wrap_block_style_google">
												<div class="title__style_google">
													О Компании — Yaradan
												</div>
												<div class="url__style_google">
													http://www.yaradan.az/ru/about-company
												</div>
												<div class="desc__style_google">
													Для предварительного просмотра заполните поле Описание
												</div>
											</div>
										</div>
									</div>
							...
							<div class="wrap__bottom__tabs__content">
								<div class="row">
									<div class="col-md-6 tal">
										<div class="style_created">
											Created by Rasim on 31.09.2017
										</div>
									</div>
									<div class="col-md-6 tar col-middle">
